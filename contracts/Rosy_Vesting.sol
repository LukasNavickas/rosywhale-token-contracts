...
contract RosyVesting is Ownable, ReentrancyGuard {
    ...
    IERC20 private immutable _addressROSY;
    ...
    function release(
        ...
        _addressROSY.safeTransfer(buyerPayable, amount);
    }
    ...
    function getWithdrawableAmount() public view returns (uint256) {
        return
            _addressROSY.balanceOf(address(this)).sub(
